...
<body>
	<form action="/barTades/login" method="post" class="form-signin">
		<div class="text-center mb-4">
			<img class="mb-4"
				src="https://img.icons8.com/plasticine/72/000000/beer.png"
				width="72" height="72">
			<h1 class="h3 mb-3 font-weight-normal">MasturBar's</h1>
		</div>
		...
		<div class="form-label-group">
			<input type="password" id="inputPassword" class="form-control"
				placeholder="Password" name="senha" required> <label
