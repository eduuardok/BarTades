        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" >
                    ...
                    <form role="form" action="${pageContext.request.contextPath}/BuscarFornecedores" method="post">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label >Razão Social</label> <input id="nome"
                                        type="text" name="nome" class="form-control" placeholder="Digite sua razão social..." disabled="">
                                </div>
                            </div>
                            
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Telefone</label> <input id="telefone" type="text" name="telefone" class="form-control" placeholder="Digite seu telefone..." maxlength="14" disabled="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label >Rua</label> <input id="endereco" type="text" name="endereco" class="form-control" placeholder="Digite a rua..." maxlength="14" disabled="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Número</label> <input id="numero" type="text" name="numero" class="form-control" placeholder="Digite o número..." maxlength="14" disabled="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Complemento</label> <input id="complemento" type="text" name="complemento" class="form-control" placeholder="Digite o complemento..." maxlength="14" disabled="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Cep</label> <input id="cep" type="text" name="cep" class="form-control" placeholder="Digite seu CEP..." maxlength="14" disabled="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Bairro</label> <input id="bairro" type="text" name="bairro" class="form-control" placeholder="Digite seu Bairro..." maxlength="14" disabled="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Cidade</label> <input id="cidade" type="text" name="cidade" class="form-control" placeholder="Digite sua cidade..." maxlength="14" disabled="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <button  type="submit"  class="btn btn-success" onclick="javascript:habilita_a();">Editar</button>
                                <button id="salva" type="submit" class="btn btn-success">Salvar</button>
                                <button id="remove" type="submit" class="btn btn-success">Remover</button>
                            </div>
                        </div>
                    </form>
                </div>
