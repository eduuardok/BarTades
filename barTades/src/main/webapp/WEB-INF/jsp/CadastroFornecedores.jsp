                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nome" value="${nome}" required="true" maxlength="150" class="form-control" placeholder="Digite sua razão social...">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Número</label> <input type="text" required="true" name="numero" value="${numero}" class="form-control" placeholder="Digite o número..." maxlength="12">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
